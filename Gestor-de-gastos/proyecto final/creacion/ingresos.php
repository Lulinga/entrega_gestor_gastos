...
<body>
    ...
    <section class="panel_crear">
        <h3>Categorías</h3>
        <section> <!--Cada 'boton' permite agregar un ingreso-->
            <a href="../creacion/crear_ingreso.php?categoria=salario" class="agregar">+<br>Salario</a>
            <a href="../creacion/crear_ingreso.php?categoria=inversiones" class="agregar">+<br>Inversiones</a>
            <a href="../creacion/crear_ingreso.php?categoria=premios" class="agregar">+<br>Premios</a>
            <a href="../creacion/crear_ingreso.php?categoria=otros" class="agregar">+<br>Otros</a>
        </section>
    </section>
</body>
</html>